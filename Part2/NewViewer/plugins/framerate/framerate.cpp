...
void Framerate::onPluginLoad()
{
    ...
    vs->compileSourceFile("framerate.vert");

    fs = new QGLShader(QGLShader::Fragment, this);
    fs->compileSourceFile("framerate.frag");
    ...
    connect(oneSecond, SIGNAL(timeout()), this, SLOT(updateFPS()));
...
void Framerate::postFrame()
{
    ...
    painter.drawText(x, y, QString("Frames per second: " + fps_str));
    painter.end();
