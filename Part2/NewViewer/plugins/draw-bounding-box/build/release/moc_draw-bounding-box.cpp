...
static const char qt_meta_stringdata_DrawBoundingBox[] = {
    "DrawBoundingBox\0"
};
...
const QMetaObjectExtraData DrawBoundingBox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DrawBoundingBox::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DrawBoundingBox,
      qt_meta_data_DrawBoundingBox, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DrawBoundingBox::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DrawBoundingBox))
