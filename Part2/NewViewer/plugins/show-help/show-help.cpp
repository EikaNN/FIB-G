...
void ShowHelp::onPluginLoad()
{
    ...
    vs->compileSourceFile("/dades/octavi.pascual/G/Part2/NewViewer/plugins/show-help/show.vert");

    fs = new QGLShader(QGLShader::Fragment, this);
    fs->compileSourceFile("/dades/octavi.pascual/G/Part2/NewViewer/plugins/show-help/show.frag");
