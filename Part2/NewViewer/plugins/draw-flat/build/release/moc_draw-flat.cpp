...
static const char qt_meta_stringdata_DrawFlat[] = {
    "DrawFlat\0"
};
...
const QMetaObjectExtraData DrawFlat::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DrawFlat::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DrawFlat,
      qt_meta_data_DrawFlat, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DrawFlat::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DrawFlat))
